                                    ...
                                    <div className="faq-wrap">
                                        <div className="accordion" id="accordionExample">
                                            {[
                                                ...
                                                {
                                                    id: 'collapseFive',
                                                    title: ' Reliable Supply & Customer Support',
                                                    content: 'Ensures timely delivery, transparent communication, and professional support to help customers complete projects smoothly and efficiently.'
                                                }       
                                            ].map((item, index) => (
