                        ...
                        <div className="row g-0">
                            <div className="col-lg-6 d-none d-lg-block">
                                <div className="product-dt-faq-img">
                                    <Image 
                                        width={650} 
                                        height={650} 
                                        src="/assets/new-images/about-page/white-cement/white_cement.png" 
                                        alt="FAQ" 
                                    />
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="faq-content-area p-4">
                                    <h2 className="mb-4">White Cement & Paint Products</h2>
                                    <div className="faq-wrap">
                                        <div className="accordion" id="accordionExample">
                                            {[
                                                {
                                                    id: 'collapseOne',
                                                    title: 'Premium Finishing Materials',
                                                    content: 'Supplies high-quality white cement and paint products designed to deliver smooth finishes, superior aesthetics, and long-lasting performance.'
                                                },
                                                {
                                                    id: 'collapseTwo',
                                                    title: 'Association with Trusted Brands',
                                                    content: 'Partnered with reputed and globally recognized brands to ensure consistent quality, durability, and advanced coating solutions.'
                                                },
                                                {
                                                    id: 'collapseThree',
                                                    title: 'Enhanced Aesthetic & Protection',
                                                    content: 'Products are selected to provide excellent brightness, color retention, weather resistance, and surface protection for interior and exterior applications.'
                                                },
                                                {
                                                    id: 'collapseFour',
                                                    title: ' Consistent Quality & Reliability',
                                                    content: 'Maintains strict quality standards and reliable sourcing to support professional construction, renovation, and decorative projects.'
                                                },
                                                
                                                {
                                                    id: 'collapseFive',
                                                    title: ' Competitive Pricing & Expert Support',
                                                    content: 'Offers premium white cement and paint solutions at competitive prices, along with professional guidance and customer support at no additional cost.'
                                                }       
                                            ].map((item, index) => (
    ...
    <div className="row mb-50">
      <div className="col-12">
        <div className="section-title-wrapper">
          ...
          <h2 className="section-main-title">Trusted White Cement & Paint Brands We Supply</h2>
        </div>
      </div>
    </div>
