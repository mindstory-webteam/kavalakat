...
const InnerPageHeader: React.FC = () => {
  ...
  const portfolioPaths = [
    ...
    '/distribution/ultratech', '/distribution/jk-cement', '/distribution/tata-steel',
    '/distribution/jsw-steel', '/distribution/asian-paints',
  ...
  return (
    <>
      <style>{`
        /* ── Blue Header Override (Inner Page) ── */
        ...
        /* Nav pill border */
        header.style-1.inner-page .main-menu > ul {
          border-color: rgba(255,255,255,0.25) !important;
        }

        /* All top-level nav links → white */
        header.style-1.inner-page .main-menu > ul > li > a {
          color: #ffffff !important;
        }
        header.style-1.inner-page .main-menu > ul > li > a svg {
          fill: #ffffff !important;
        }

        /* Active / hover pill → white bg, blue text */
        header.style-1.inner-page .main-menu > ul > li:hover > a,
        header.style-1.inner-page .main-menu > ul > li.active > a {
          background-color: #ffffff !important;
          color: #0057C8 !important;
        }
        header.style-1.inner-page .main-menu > ul > li:hover > a svg,
        header.style-1.inner-page .main-menu > ul > li.active > a svg {
          fill: #0057C8 !important;
        }

        /* Contact area (phone) → white */
        header.style-1.inner-page .contact-area .icon {
          background-color: rgba(255,255,255,0.15) !important;
        }
        header.style-1.inner-page .contact-area .icon svg {
          fill: #ffffff !important;
        }
        header.style-1.inner-page .contact-area .content span {
          color: rgba(255,255,255,0.75) !important;
        }
        header.style-1.inner-page .contact-area .content a {
          color: #ffffff !important;
        }

        /* Divider → white */
        header.style-1.inner-page .nav-right::before {
          background-color: rgba(255,255,255,0.4) !important;
        }

        /* GET IN TOUCH button → white outline, white text */
        header.style-1.inner-page .nav-right .right-sidebar-button {
          background-color: rgba(255,255,255,0.15) !important;
          border: 1px solid rgba(255,255,255,0.3) !important;
        }
        header.style-1.inner-page .nav-right .right-sidebar-button svg {
          fill: #ffffff !important;
        }
        header.style-1.inner-page .nav-right .right-sidebar-button span {
          color: #ffffff !important;
        }
        header.style-1.inner-page .nav-right .right-sidebar-button:hover {
          background-color: #ffffff !important;
        }
        header.style-1.inner-page .nav-right .right-sidebar-button:hover svg {
          fill: #0057C8 !important;
        }
        header.style-1.inner-page .nav-right .right-sidebar-button:hover span {
          color: #0057C8 !important;
        }

        /* Mobile hamburger → white */
        header.style-1.inner-page .nav-right .mobile-menu-btn {
          border-color: rgba(255,255,255,0.35) !important;
        }
        header.style-1.inner-page .nav-right .mobile-menu-btn svg {
          fill: #ffffff !important;
        }

        /* Dropdown +/- icon → white */
        header.style-1.inner-page .main-menu > ul > li .bi {
          color: #ffffff !important;
        }

        /* Sub-menu column title accent → blue */
        header.style-1.inner-page .main-menu > ul > li ul.sub-menu.product-mega-submenu .column-title {
              ...
              <li>
                <div className="single-contact social">
                  ...
                  <div className="content">
                    <span>Follow Us</span>
                    <h6>
                      <a href="https://www.facebook.com/kavalakatindia/">Facebook,</a>{" "}
      ...
      <header className={`header-area style-1 inner-page ${state.scrollY > 20 ? "sticky" : ""}`}>
        <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
          <div className="company-logo">
            <Link href="/">
              <img width={157} height={34} alt="image" className="img-fluid" src="/assets/new-images/logo/KavalakkatLogo-white.png" />
            </Link>
          </div>
