                                        ...
                                        <div className="row gy-md-5 gy-4 align-items-center justify-content-between">
                                            ...
                                            <div className="col-lg-7">
                                                <div className="testimonial-content">
                                                    ...
                                                    <p>“Feel free customize keyed onent feature based one the services &amp; strategy your offer each plan. This breakdown help various potential Meet the social team behind leading brands Located at Overtoomai clients are fundamental Gong”.</p>
                                        ...
                                        <div className="row gy-md-5 gy-4 align-items-center justify-content-between">
                                            ...
                                            <div className="col-lg-7">
                                                <div className="testimonial-content">
                                                    ...
                                                    <p>“You are welcome to modify the key feature according to the services you provide for each plan. This breakdown offers several potential Meet the social media team that oversees top businesses.where clients are essential the Gong”.</p>
                                                    <div className="author-and-social-area">
                                                        <div className="author-area">
                                                            <div className="author-img">
