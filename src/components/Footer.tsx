                            ...
                            <div className="col-lg-9 mt-5">
                                <div className="footer-menu">
                                    <div className="row gy-5">
                                        ...
                                        <div className="col-md-3 col-sm-6 d-flex justify-content-lg-center">
                                            <div className="footer-widget">
                                                <div className="widget-title"><h5>Products</h5></div>
                                                <ul className="footer-nav-list">
                                                    {[
                                        ...
                                        <div className="col-md-2 col-sm-6 d-flex justify-content-lg-center">
                                            <div className="footer-widget">
                                                ...
                                                {/* <div className="widget-title" style={{ marginTop: '24px' }}><h5>Logistics</h5></div>
                                                <ul className="footer-nav-list">
                                                    <li>
                                                        <Link href="/services/kavalakat-group" className="footer-nav-link">
                                                            <span className="footer-nav-arrow"><LinkArrow /></span>
                                                            <span className="footer-nav-text">Kavalakat Group</span>
                                                        </Link>
                                                    </li>
                                                </ul> */}
                                            </div>
                                                    ...
                                                    <div className="single-contact">
                                                        <div className="icon">
                                                            <svg width={33} height={32} viewBox="0 0 33 32" xmlns="http://www.w3.org/2000/svg">
                                                                <path fillRule="evenodd" clipRule="evenodd" d="M32.9896 1.18398C33.0176 0.995671 32.993 0.803292 32.9185 0.628097C32.844 0.452902 32.7225 0.301711 32.5675 0.191227C32.4126 0.0808885 32.2301 0.0155543 32.0404 0.00245033C31.8506 -0.0106536 31.6609 0.0289832 31.4923 0.116977L0.554753 16.2732C0.376749 16.3673 0.230082 16.5113 0.132753 16.6876C0.0354241 16.8638 -0.0083331 17.0646 0.00685184 17.2654C0.0220368 17.4662 0.0955032 17.6581 0.218235 17.8177C0.340966 17.9773 0.507624 18.0976 0.697753 18.1639L9.29838 21.1036L27.6148 5.44235L13.4413 22.5185L27.8554 27.4451C27.9984 27.4932 28.1502 27.5094 28.3002 27.4926C28.4501 27.4758 28.5946 27.4265 28.7235 27.348C28.8524 27.2696 28.9625 27.1639 29.0463 27.0384C29.1301 26.9129 29.1854 26.7706 29.2084 26.6215L32.9896 1.18398ZM28.2201 26.469C28.2192 26.4738 28.2172 26.4792 28.2145 26.4833C28.2117 26.4876 28.2079 26.4912 28.2035 26.4939C28.1991 26.4965 28.1942 26.4982 28.189 26.4988C28.1842 26.4993 28.1793 26.4989 28.1746 26.4974L15.1369 22.0413L28.3842 6.08103L26.9649 4.68231L9.08205 19.9729L1.02672 17.2195C1.02082 17.2173 1.01481 17.2131 1.01095 17.2081C1.00692 17.2029 1.0045 17.1966 1.004 17.19C1.0035 17.1834 1.00494 17.1768 1.00814 17.171C1.01122 17.1654 1.0158 17.1608 1.02135 17.1577L31.9549 1.00355C31.9599 1.00093 31.9658 0.999681 31.9715 1.00007" />
                                                                <path d="M13.0319 30.5897V25.6152L16.0115 26.6335L13.0902 30.6089C13.0862 30.6141 13.0807 30.6179 13.0744 30.6199C13.0678 30.622 13.0608 30.622 13.0543 30.6199C13.0478 30.6177 13.0421 30.6136 13.0381 30.6081C13.0342 30.6027 13.0321 30.5963 13.0319 30.5897ZM12.0319 24.2166L17.624 26.1279L13.8936 31.2044C13.7644 31.3784 13.5838 31.5073 13.3772 31.573C13.1707 31.6386 12.9487 31.6376 12.7427 31.5701C12.5368 31.5025 12.3573 31.3719 12.2297 31.1967C12.1021 31.0215 12.0329 30.8106 12.0319 30.5939V24.2166Z" />
                                                            </svg>
                                                        </div>
                                                        <div className="content">
                                                            <span>SAY HELLO</span>
